  ...
  describe('lo público y lo protegido', () => {
    ...
    it('todas las rutas de administración exigen el token', async () => {
      ...
      const rutas = [
        ...
        ['get', `/api/admin/events/${event.id}/competition/tie-resolutions`],
        ['post', `/api/admin/events/${event.id}/competition/tie-resolutions`],
        ['delete', `/api/admin/events/${event.id}/competition/tie-resolutions`],
