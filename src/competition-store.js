...
function migrateCompetition(connection, defaultEventId) {
  connection.transaction(() => {
    ...
    connection.prepare("INSERT OR IGNORE INTO event_hosts(event_id,name,identifier,enabled) VALUES (?,'Host Grupo A','HOST_1',1)").run(defaultEventId);
    connection.prepare("INSERT OR IGNORE INTO event_hosts(event_id,name,identifier,enabled) VALUES (?,'Host Grupo B','HOST_2',1)").run(defaultEventId);
