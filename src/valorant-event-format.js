...
const OFFICIAL_VALORANT_FORMAT = Object.freeze({
  ...
  */
  ...
  public: Object.freeze({
    ...
    draft: 'El draft se celebra en un día aparte, por Discord: en directo, en un canal de voz y con elecciones públicas por turnos. Habrá cuatro rondas de elección. La organización anunciará el orden definitivo antes del draft y podrá utilizar orden serpiente. Los que eligen son los capitanes, así que no hace falta que estés conectado para que te elijan, aunque se agradece verlo.',
    ...
    days: 'El draft va en su propio día, por Discord, y no ocupa tiempo de juego. El torneo se reparte después en varias tardes, porque de una sentada no cabe: cada eliminatoria tiene que esperar a que termine la anterior. Con 20 jugadores salen tres tardes —la liga la primera, y las eliminatorias repartidas en las otras dos— de unas dos a cuatro horas cada una. Las fechas concretas salen del calendario de disponibilidad y se anuncian con antelación.',
